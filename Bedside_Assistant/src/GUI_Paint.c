...
//    osal_printk("WidthByte = %d, HeightByte = %d\r\n", Paint.WidthByte, Paint.HeightByte);
//    osal_printk(" EPD_WIDTH / 8 = %d\r\n",  122 / 8);
                     ...
                     DOT_PIXEL Dot_Pixel, DOT_STYLE Dot_Style)
{
    if (Xpoint > Paint.Width || Ypoint > Paint.Height) {
        Debug("Paint_DrawPoint Input exceeds the normal display range\r\n");
				osal_printk("Xpoint = %d , Paint.Width = %d  \r\n ",Xpoint,Paint.Width);
				osal_printk("Ypoint = %d , Paint.Height = %d  \r\n ",Ypoint,Paint.Height);
        return;
    }
